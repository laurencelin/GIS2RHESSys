		...
		for(hilli in 1:num_hill){
			...
			for(zonei in 1:num_zone){	#this num_zone need to read from a quick table
				...
				for(patchi in 1:num_patch){
					...
					strateIndex_ = strateIndex[strateIndex[,1]==worldID & strateIndex[,2]==basinID & strateIndex[,3]==hillID & strateIndex[,4]==zoneID & strateIndex[,5]==patchID,]
					num_strate = LIBnrow(strateIndex_)
					if(num_strate==1){strateIndex_ = t(as.matrix(strateIndex_)) }
					...
					for(stratei in 1:num_strate){
						...
						strateID = dd[strateIndex_[stratei,7],'strateID']
						line=c(
							paste("",formatC(strateID,width=31,format="d",digits=0,flag="-"),"canopy_strata_ID",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],64],width=31,format="d",digits=0,flag="-"),"default_ID",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],65],width=31,format="f",digits=16,flag="-"),"cover_fraction",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],66],width=31,format="f",digits=16,flag="-"),"gap_fraction",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],67],width=31,format="f",digits=16,flag="-"),"root_depth",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],68],width=31,format="f",digits=16,flag="-"),"snow_stored",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],69],width=31,format="f",digits=16,flag="-"),"rain_stored",sep=""),	
							paste("",formatC(dd[strateIndex_[stratei,7],70],width=31,format="f",digits=16,flag="-"),"cs_cpool",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],71],width=31,format="f",digits=16,flag="-"),"cs_leafc",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],72],width=31,format="f",digits=16,flag="-"),"cs_dead_leafc",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],73],width=31,format="f",digits=16,flag="-"),"cs_leafc_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],74],width=31,format="f",digits=16,flag="-"),"cs_leafc_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],75],width=31,format="f",digits=16,flag="-"),"cs_live_stemc",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],76],width=31,format="f",digits=16,flag="-"),"cs_livestemc_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],77],width=31,format="f",digits=16,flag="-"),"cs_livestemc_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],78],width=31,format="f",digits=16,flag="-"),"cs_dead_stemc",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],79],width=31,format="f",digits=16,flag="-"),"cs_deadstemc_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],80],width=31,format="f",digits=16,flag="-"),"cs_deadstemc_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],81],width=31,format="f",digits=16,flag="-"),"cs_live_crootc",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],82],width=31,format="f",digits=16,flag="-"),"cs_livecrootc_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],83],width=31,format="f",digits=16,flag="-"),"cs_livecrootc_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],84],width=31,format="f",digits=16,flag="-"),"cs_dead_crootc",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],85],width=31,format="f",digits=16,flag="-"),"cs_deadcrootc_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],86],width=31,format="f",digits=16,flag="-"),"cs_deadcrootc_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],87],width=31,format="f",digits=16,flag="-"),"cs_frootc",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],88],width=31,format="f",digits=16,flag="-"),"cs_frootc_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],89],width=31,format="f",digits=16,flag="-"),"cs_frootc_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],90],width=31,format="f",digits=16,flag="-"),"cs_cwdc",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],91],width=31,format="f",digits=16,flag="-"),"epv.prev_leafcalloc",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],92],width=31,format="f",digits=16,flag="-"),"ns_npool",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],93],width=31,format="f",digits=16,flag="-"),"ns_leafn",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],94],width=31,format="f",digits=16,flag="-"),"ns_dead_leafn",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],95],width=31,format="f",digits=16,flag="-"),"ns_leafn_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],96],width=31,format="f",digits=16,flag="-"),"ns_leafn_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],97],width=31,format="f",digits=16,flag="-"),"ns_live_stemn",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],98],width=31,format="f",digits=16,flag="-"),"ns_livestemn_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],99],width=31,format="f",digits=16,flag="-"),"ns_livestemn_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],100],width=31,format="f",digits=16,flag="-"),"ns_dead_stemn",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],101],width=31,format="f",digits=16,flag="-"),"ns_deadstemn_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],102],width=31,format="f",digits=16,flag="-"),"ns_deadstemn_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],103],width=31,format="f",digits=16,flag="-"),"ns_live_nrootn",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],104],width=31,format="f",digits=16,flag="-"),"ns_livenrootn_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],105],width=31,format="f",digits=16,flag="-"),"ns_livenrootn_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],106],width=31,format="f",digits=16,flag="-"),"ns_dead_nrootn",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],107],width=31,format="f",digits=16,flag="-"),"ns_deadnrootn_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],108],width=31,format="f",digits=16,flag="-"),"ns_deadnrootn_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],109],width=31,format="f",digits=16,flag="-"),"ns_frootn",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],110],width=31,format="f",digits=16,flag="-"),"ns_frootn_store",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],111],width=31,format="f",digits=16,flag="-"),"ns_frootn_transfer",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],112],width=31,format="f",digits=16,flag="-"),"ns_nwdn",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],113],width=31,format="f",digits=16,flag="-"),"ns_retransn",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],114],width=31,format="f",digits=16,flag="-"),"epv_wstress_days",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],115],width=31,format="f",digits=16,flag="-"),"epv_max_fparabs",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],116],width=31,format="f",digits=16,flag="-"),"epv_min_vwc",sep=""),
							paste("",formatC(dd[strateIndex_[stratei,7],117],width=31,format="d",digits=0,flag="-"),"n_basestations",sep="")
						)
						write(line,file=outputfile,ncolumn=1,append=T)
					}#stratei
				}#patchi
